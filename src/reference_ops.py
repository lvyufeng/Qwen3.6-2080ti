...
class LinearDispatchStats:
    ...
    moe_native_assignment_parallel_calls: int = 0
    moe_native_assignment_parallel_eligible: int = 0
    moe_native_assignment_parallel_hits: int = 0
    moe_native_assignment_parallel_fallbacks: int = 0
    moe_native_assignment_parallel_fallback_disabled: int = 0
    moe_native_assignment_parallel_fallback_small: int = 0
    moe_native_assignment_parallel_fallback_capacity: int = 0
    moe_native_assignment_parallel_fallback_device: int = 0
    moe_native_assignment_parallel_fallback_dtype: int = 0
    moe_native_assignment_parallel_fallback_shape: int = 0
    moe_native_assignment_parallel_fallback_missing_scale: int = 0
    moe_native_assignment_parallel_fallback_exception: int = 0
    moe_native_assignment_parallel_capacity: int = 0
