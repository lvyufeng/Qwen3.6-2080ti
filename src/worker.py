...
def _dispatch_stats_data(result: GenerateResult) -> dict[str, Any]:
    ...
    return {
        ...
        "moe_native_assignment_parallel_calls": dispatch.moe_native_assignment_parallel_calls,
        "moe_native_assignment_parallel_eligible": dispatch.moe_native_assignment_parallel_eligible,
        "moe_native_assignment_parallel_hits": dispatch.moe_native_assignment_parallel_hits,
        "moe_native_assignment_parallel_fallbacks": dispatch.moe_native_assignment_parallel_fallbacks,
        "moe_native_assignment_parallel_fallback_disabled": dispatch.moe_native_assignment_parallel_fallback_disabled,
        "moe_native_assignment_parallel_fallback_small": dispatch.moe_native_assignment_parallel_fallback_small,
        "moe_native_assignment_parallel_fallback_capacity": dispatch.moe_native_assignment_parallel_fallback_capacity,
        "moe_native_assignment_parallel_fallback_device": dispatch.moe_native_assignment_parallel_fallback_device,
        "moe_native_assignment_parallel_fallback_dtype": dispatch.moe_native_assignment_parallel_fallback_dtype,
        "moe_native_assignment_parallel_fallback_shape": dispatch.moe_native_assignment_parallel_fallback_shape,
        "moe_native_assignment_parallel_fallback_missing_scale": dispatch.moe_native_assignment_parallel_fallback_missing_scale,
        "moe_native_assignment_parallel_fallback_exception": dispatch.moe_native_assignment_parallel_fallback_exception,
        "moe_native_assignment_parallel_capacity": dispatch.moe_native_assignment_parallel_capacity,
