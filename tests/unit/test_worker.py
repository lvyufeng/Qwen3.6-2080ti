...
def test_worker_load_then_generate_single_rank(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    assert "moe_native_assignment_offsets_calls" in generate_result.data["dispatch"]
    assert "moe_native_assignment_offsets_fallback_device" in generate_result.data["dispatch"]
    assert "moe_native_assignment_parallel_calls" in generate_result.data["dispatch"]
    assert "moe_native_assignment_parallel_hits" in generate_result.data["dispatch"]
    assert "moe_native_assignment_parallel_fallback_disabled" in generate_result.data["dispatch"]
    assert "moe_native_assignment_parallel_fallback_capacity" in generate_result.data["dispatch"]
    assert "moe_native_assignment_parallel_capacity" in generate_result.data["dispatch"]
    ...
    assert "moe_native_grouped_dispatch_offsets_calls" in generate_result.data["dispatch"]
    assert "moe_native_grouped_dispatch_offsets_fallback_device" in generate_result.data["dispatch"]
    assert "moe_native_grouped_dispatch_offsets_segmented_calls" in generate_result.data["dispatch"]
    assert "moe_native_grouped_dispatch_offsets_segmented_fallback_small" in generate_result.data["dispatch"]
    assert "moe_native_grouped_dispatch_offsets_segmented_capacity" in generate_result.data["dispatch"]
